...
namespace NeptunePhysics {
	...
	//TODO
	void npParticleForceRegistry::remove(npParticle* particle, npParticleForceGenerator * generator)
	{
		/*_Registry::iterator i = registration.begin();
		for (; i < registration.end(); i++)
		{
			if (i->particle == particle && i->fg == generator) {
